...
git branch -d <имя ветки>1
```
### Заключение

**Git** — это мощный инструмент, который позволяет вам эффективно управлять версиями вашего кода. Понимание и регулярное использование основных команд помогут вам лучше организовать вашу работу и сохранить её историю.